...
public class GestorVuelos {
    ...
    public void addVuelo(Vuelo vuelo) {
        ...
        System.out.println("Vuelo guardado correctamente: " + vuelos[vuelos.length - 1]);
    }
    ...
    public Vuelo textoAddVuelo() {
        ...
        return new Vuelo(id,origen,destino,fechaSalida,fechaLlegada,num_pasajeros,max_pasajeros,precio);
    }
    ...
    public void mostrarVuelosPosteriores(LocalDateTime fecha){
        ...
        for (Vuelo vuelo : vuelos) {
            if ((vuelo.getFechaSalida().isAfter(fecha) || vuelo.getFechaSalida().isEqual(fecha)) && vuelo.getNumPasajeros() < vuelo.getMAX_PASAJEROS()) {
